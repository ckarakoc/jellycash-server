...
public class JwtService {
  ...
  public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
    return buildToken(extraClaims, userDetails, new Date(
        System.currentTimeMillis() + AppConstants.JwtTokenExpiry.ACCESS_TOKEN_EXPIRY.toMillis()));
  }

  public <T extends User> RefreshToken generateRefreshToken(T userDetails) {
    return generateRefreshToken(userDetails, new Date(
        System.currentTimeMillis() + AppConstants.JwtTokenExpiry.REFRESH_TOKEN_EXPIRY.toMillis()));
  }
