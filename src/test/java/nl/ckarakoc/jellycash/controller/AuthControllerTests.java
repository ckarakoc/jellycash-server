...
public class AuthControllerTests extends BaseControllerTest {
  ...
  public class RegisterTests {
    ...
    @Test
    void shouldReturn204_whenValidRequestGiven() throws Exception {
    ...
    @Test
    public void shouldReturn409Conflict_whenUserAlreadyExists() throws Exception {
      AuthRegisterRequestDto validRequest = AuthRegisterRequestDto.builder()
          .email("mark@rutte.nl")
          .password("Vergeten@123")
          .confirmPassword("Vergeten@123")
    ...
    @ParameterizedTest
    public void shouldReturn400BadRequest_whenInvalidRequestGiven(
        String email,
        String password,
  ...
  class LoginTests {
    ...
    public void shouldReturn200_whenValidRequestGiven() throws Exception {
    }

    public void shouldReturn401Unauthorized_whenInvalidCredentials() throws Exception {
    }

    public void shouldReturn403Forbidden_whenAccountIsLocked() throws Exception {
    }
  }
  ...
  class LogoutTests {
    ...
    public void shouldReturn401Unauthorized_whenInvalidToken() throws Exception {
    }
  }
  ...
  class RefreshTests {
    ...
    public void shouldReturn401Unauthorized_whenInvalidRefreshToken() throws Exception {
    }
  }
}
