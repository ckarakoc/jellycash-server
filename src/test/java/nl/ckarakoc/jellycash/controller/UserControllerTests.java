...
public class UserControllerTests extends BaseControllerTest {
	...
	public void shouldReturnBadRequest_whenInvalidRequestGiven(String email, String password, String firstName, String lastName, String check) throws Exception {
